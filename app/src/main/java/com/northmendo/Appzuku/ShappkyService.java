...
public class ShappkyService extends Service {
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        switch (action) {
            ...
            case "SCREEN_ON":
                ...
                boolean timerWasPending = cancelIdleFreezeTimer();
                if (!timerWasPending) {
                    // Timer already fired — apps were frozen, unfreeze them now
     ...
     * @return true if the timer was still pending (had not fired yet), false if it had already fired
     */
    private boolean cancelIdleFreezeTimer() {
        if (idleFreezeRunnable != null) {
            boolean removed = handler.removeCallbacks(idleFreezeRunnable);
