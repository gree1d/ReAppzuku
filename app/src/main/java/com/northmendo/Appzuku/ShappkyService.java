...
public class ShappkyService extends Service {
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        switch (action) {
            ...
            case "SCREEN_OFF":
                ...
                Log.d(TAG, "Idle freeze alarm scheduled (" + (IDLE_FREEZE_DELAY_MS / 60000) + " min)");
                break;
            ...
            case "IDLE_FREEZE":
                // Triggered by FreezeReceiver when AlarmManager alarm fires
    ...
    /**
     * Schedules an exact alarm to trigger freeze after IDLE_FREEZE_DELAY_MS.
    ...
    private void scheduleIdleFreezeAlarm() {
        ...
        long triggerAt = System.currentTimeMillis() + IDLE_FREEZE_DELAY_MS;
